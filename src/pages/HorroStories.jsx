  ...
  return (
    <div className="stories-container">
      <div className="story1">
        ...
        <div className="stories-container">
          <div className="story1">
            <h1 id="tarinat" className="story1headline">
              Marjatta 71-v. ja Anni 72-v. jäi arvontahujauksen uhreiksi
            </h1>
            <div className="descriptionandstory">
              ...
              <div className="story1-description">
                <p>
                  Marjatta ja Anni ovat kotoisin Porvoosta ja ovat olleet
                  ystäviä jo pitkään. <br></br>
                  <br></br>
                  ...
                  <br></br>
                  Facebook-viestissä Marjatta kysyi Annin puhelinnumeroa ja
                  kertoi, että he olivat osallistuneet yhdessä arvontaan ja
                  voittaneet.
                  ...
                  kuusinumeroisia koodeja, joita olin saanut puhelimeeni ja
                  annoin ne hänelle.
                  <br></br> <br></br>
                  Seuraavana päivänä Anni soitti Marjattalle selvittääkseen,
                  mistä arvonnasta oli oikein kyse.
                  ...
                  Facebook-tili oli kaapattu. Kuusinumeroisten koodien kautta
                  myös useat Anniin liittyvät tilit oli saatu haltuun.
                  <br></br> <br></br>
                  Anni ja Marjatta ilmoittivat asiasta poliisille ja pankille.
                  He neuvoivat Annia vaihtamaan salasanansa ja tekemään niistä
          ...
          <div className="descriptionandstory">
            ...
            <div className="story-description">
              <p>
                Marjatta ja Anni ovat kotoisin Porvoosta ja ovat olleet ystäviä
                jo pitkään. <br></br>
                <br></br>
                Anni kertoo, kuinka hän eräänä päivänä sai tavallisen
                Facebook-viestin Marjattalta. Yleensä he juttelevat
        ...
        <div className="story2">
          ...
          <div className="descriptionandstory">
            ...
            <div className="story-description">
              <p>
                Helmikuussa Onni Kivivuorelle soitti henkilö, joka kertoi
                olevansa Norwegian Bankista ja väitti, että Onnin tilillä oli
                havaittu huolestuttavaa toimintaa. Onni vastasi, ettei käytä
                Norwegian Bankia, vaan hänen pankkinsa on Nordea. Puhelimessa
                ollut henkilö sanoi: "Selvä, saat pian soiton Nordeasta."{" "}
                <br></br> <br></br>
                ...
                vakuuttava ja puhui sujuvaa suomea. Menin paniikkiin, koska
                luulin säästöjeni olevan vaarassa, Onni kertoo.
                <br></br> <br></br>Onni toimi puhelimessa olleen
                “Nordea-henkilön” ohjeiden mukaan ja antoi pankkitunnuksensa.
                Kun hän lopetti puhelun, oikea Nordea oli yrittänyt soittaa
                hänelle. Silloin Onni ymmärsi, mitä oli tapahtunut. Kun Onni
                soitti pankkiin takaisin, he vahvistivat hänen epäilynsä: rahat
                hänen tililtään olivat kadonneet.
                <br></br> <br></br>
                Kun Onni pyysi pankkia keskeyttämään siirron, hän sai
                järkytyksen, se ei ollut enää mahdollista, sillä rahat oli jo
                nostettu ja siirretty puolalaiselle pankkitilille. Kyseessä oli
                kymmeniä tuhansia euroja.
                <br></br> <br></br>Onni teki asiasta rikosilmoituksen, ja
                poliisi alkoi heti tutkia tapausta.
                <br></br> <br></br>
                Puoli vuotta myöhemmin, kun Onni tarkisti verkkopankkinsa, hän
                yllättyi suuresti – tilille oli ilmestynyt lähes sama summa,
                jonka hän oli menettänyt puoli vuotta aiemmin. Rahat oli
                palauttanut Puolan syyttäjänvirasto. Onni oli jo ajatellut, että
                rahat olivat lopullisesti mennyttä, mutta Puolan ja Suomen
                poliisin sekä syyttäjän yhteistyön ansiosta Onni sai lähes
          ...
          <div className="descriptionandstory">
            ...
            <div className="story-description">
              <p>
                ...
                houkutella klikkaamaan linkkiä saadakseen pääsyn
                henkilökohtaisiin tietoihin tai pankkitunnuksiin.
                <br></br> <br></br>
                ...
                pankkitunnuksiaan.
                <br></br> <br></br>– Ajattelin, että viesti oli luotettava,
                koska se näytti tulevan osoitteesta vero.fi:sta ja asia vaikutti
